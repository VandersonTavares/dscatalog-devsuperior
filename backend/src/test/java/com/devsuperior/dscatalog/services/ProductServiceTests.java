...
public class ProductServiceTests {
	...
	public void findByIdShouldThrowResourceNotFoundExceptionWhenNonExistsId() {
		Assertions.assertThrows(ResourceNotFoundException.class, () -> {
			ProductDTO p = service.findById(nonExistingId);
		});
	}
	
	@Test 
	public void updateShouldThrowResourceNotFoundExceptionWhenNonExistsId() {
	...
	public void updateShouldReturnProductDTOWhenExistsId() {	
		...
		ProductDTO p = service.update(existingId, productDTO);
		Assertions.assertNotNull(p);
	}
	...
	@Test
	public void deleteShouldDoNothigWhenExistsId() {
